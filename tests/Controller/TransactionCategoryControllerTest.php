...
class TransactionCategoryControllerTest extends ControllerBaseCase {
    ...
    public function testAnonTypeahead() : void {
        $this->client->request('GET', '/transaction_category/typeahead?q=STUFF');
    ...
    public function testAnonDelete() : void {
        $crawler = $this->client->request('GET', '/transaction_category/1/delete');
        $this->assertSame(302, $this->client->getResponse()->getStatusCode());
        $this->assertTrue($this->client->getResponse()->isRedirect());
    }
    ...
    public function testAdminDelete() : void {
        $preCount = count($this->entityManager->getRepository(TransactionCategory::class)->findAll());
        $this->login('user.admin');
        $crawler = $this->client->request('GET', '/transaction_category/1/delete');
        $this->assertSame(302, $this->client->getResponse()->getStatusCode());
        $this->assertTrue($this->client->getResponse()->isRedirect());
        ...
        $postCount = count($this->entityManager->getRepository(TransactionCategory::class)->findAll());
