...
class EventCategoryControllerTest extends ControllerBaseCase {
    ...
    public function testAnonTypeahead() : void {
        $this->client->request('GET', '/event_category/typeahead?q=STUFF');
    ...
    public function testAdminEdit() : void {
        ...
        $this->assertTrue($this->client->getResponse()->isRedirect('/event_category/1'));
    ...
    public function testAnonDelete() : void {
        $crawler = $this->client->request('GET', '/event_category/1/delete');
        $this->assertSame(302, $this->client->getResponse()->getStatusCode());
        $this->assertTrue($this->client->getResponse()->isRedirect());
    }
    ...
    public function testAdminDelete() : void {
        $preCount = count($this->entityManager->getRepository(EventCategory::class)->findAll());
        $this->login('user.admin');
        $crawler = $this->client->request('GET', '/event_category/1/delete');
        $this->assertSame(302, $this->client->getResponse()->getStatusCode());
        $this->assertTrue($this->client->getResponse()->isRedirect());
        ...
        $postCount = count($this->entityManager->getRepository(EventCategory::class)->findAll());
