...
class CityControllerTest extends BaseTestCase {
    ...
    public function testAnonTypeahead() : void {
        $client = $this->makeClient();
        $client->request('GET', '/city/typeahead?q=STUFF');
    ...
    public function testAnonNew() : void {
        $client = $this->makeClient();
        $crawler = $client->request('GET', '/city/new');
        $this->assertSame(302, $client->getResponse()->getStatusCode());
        $this->assertTrue($client->getResponse()->isRedirect());
    }
    ...
    public function testAnonNewPopup() : void {
        $client = $this->makeClient();
        $crawler = $client->request('GET', '/city/new_popup');
        $this->assertSame(302, $client->getResponse()->getStatusCode());
        $this->assertTrue($client->getResponse()->isRedirect());
    }
    ...
    public function testAnonDelete() : void {
        $client = $this->makeClient();
        $crawler = $client->request('GET', '/city/1/delete');
        $this->assertSame(302, $client->getResponse()->getStatusCode());
        $this->assertTrue($client->getResponse()->isRedirect());
    }
    ...
    public function testAdminDelete() : void {
        $preCount = count($this->em->getRepository(City::class)->findAll());
        $client = $this->makeClient(LoadUser::ADMIN);
        $crawler = $client->request('GET', '/city/1/delete');
        $this->assertSame(302, $client->getResponse()->getStatusCode());
        $this->assertTrue($client->getResponse()->isRedirect());
