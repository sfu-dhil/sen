 ...
 * @coversNothing
 */
class RelationshipCategoryTest extends ControllerBaseCase {
    ...
    public function testAnonIndex() : void {
        $crawler = $this->client->request('GET', '/relationship_category/');
    ...
    public function testAnonShow() : void {
        $crawler = $this->client->request('GET', '/relationship_category/1');
        static::assertSame(self::ANON_RESPONSE_CODE, $this->client->getResponse()->getStatusCode());
    ...
    public function testAnonTypeahead() : void {
        $this->client->request('GET', '/relationship_category/typeahead?q=' . self::TYPEAHEAD_QUERY);
    ...
    public function testAnonSearch() : void {
        $repo = $this->createMock(RelationshipCategoryRepository::class);
        $repo->method('searchQuery')->willReturn([$this->getReference('relationshipcategory.1')]);
        $this->client->disableReboot();
        $this->client->getContainer()->set('test.' . RelationshipCategoryRepository::class, $repo);

        $crawler = $this->client->request('GET', '/relationship_category/search');
        static::assertSame(self::ANON_RESPONSE_CODE, $this->client->getResponse()->getStatusCode());
        if (self::ANON_RESPONSE_CODE === Response::HTTP_FOUND) {
            // If authentication is required stop here.
            return;
    ...
    public function testAnonEdit() : void {
        $crawler = $this->client->request('GET', '/relationship_category/1/edit');
    ...
    public function testAdminEdit() : void {
        $this->login('user.admin');
        $formCrawler = $this->client->request('GET', '/relationship_category/1/edit');
        static::assertSame(Response::HTTP_OK, $this->client->getResponse()->getStatusCode());
        ...
        static::assertTrue($this->client->getResponse()->isRedirect('/relationship_category/1'));
    ...
    public function testAnonNew() : void {
        $crawler = $this->client->request('GET', '/relationship_category/new');
        static::assertSame(Response::HTTP_FOUND, $this->client->getResponse()->getStatusCode());
        static::assertTrue($this->client->getResponse()->isRedirect());
    }
    ...
    public function testAnonNewPopup() : void {
        $crawler = $this->client->request('GET', '/relationship_category/new_popup');
        static::assertSame(Response::HTTP_FOUND, $this->client->getResponse()->getStatusCode());
        static::assertTrue($this->client->getResponse()->isRedirect());
    }
    ...
    public function testAdminNew() : void {
        $this->login('user.admin');
        $formCrawler = $this->client->request('GET', '/relationship_category/new');
        static::assertSame(Response::HTTP_OK, $this->client->getResponse()->getStatusCode());
    ...
    public function testAdminNewPopup() : void {
        $this->login('user.admin');
        $formCrawler = $this->client->request('GET', '/relationship_category/new_popup');
        static::assertSame(Response::HTTP_OK, $this->client->getResponse()->getStatusCode());
    ...
    public function testAdminDelete() : void {
        $repo = self::$container->get(RelationshipCategoryRepository::class);
